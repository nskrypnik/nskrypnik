...
class Photo(models.Model):
    ...
    def get_thumbnail_html(self):
        html = '<a class="image-picker" href="%s%s"><img src="%s%s" alt="%s"/></a>' % (settings.MEDIA_URL, self.image.url, settings.MEDIA_URL, get_thumbnail_url(self.image.url), self.title)
        return html
